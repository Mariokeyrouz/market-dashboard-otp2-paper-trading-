...
def _step(state, px_today, market_row, date_str=None):
    ...
    if date_str is not None:
        record_fills("FMTS", date_str, prev_shares, shares, px_today,
...
def main():
    ...
    if os.path.exists(STATE_PATH):
        ...
        if set(held_tickers) != set(tickers):
            ...
            record_fills("FMTS", str(common_index[-1].date()), _osh, shares_new,
        ...
        record_fills("FMTS", str(seed_date.date()), {}, shares, entry_prices,
