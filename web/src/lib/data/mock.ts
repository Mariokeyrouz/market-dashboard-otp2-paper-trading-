...
const DATA: Record<Region, CoreData> = {
  ...
  EU: {
    exchange: "Euronext · CET", regimeLabel: "Disinflation", regimeColor: "var(--green)", regimeDays: 88, regimeSince: "Apr 4",
    history: [
      { label: "Stagnation", color: "var(--amber)", w: 44 },
      { label: "Reflation", color: "#8FA05A", w: 24 },
      { label: "Disinflation", color: "var(--green)", w: 56 },
      { label: "Disinflation", color: "var(--green)", w: 28 },
    ],
    ...
    playbook: [
      { side: "LONG", asset: "Bund duration", note: "cuts ahead", color: "var(--green)" },
      { side: "LONG", asset: "EU periphery", note: "spread carry", color: "var(--green)" },
      { side: "FADE", asset: "EUR/USD rallies", note: "rate diff", color: "var(--amber)" },
      { side: "LONG", asset: "EU cyclicals", note: "easing beta", color: "var(--green)" },
    ],
    curve: [["3M", 3.4], ["1Y", 2.95], ["2Y", 2.55], ["5Y", 2.4], ["7Y", 2.48], ["10Y", 2.44], ["30Y", 2.72]],
    tripwires: [
      { label: "Credit · iTraxx XO", tag: "Leading tell for equity stress", val: "298", chg: -6, unit: "", state: "bp", note: "Tightening = risk appetite firm.", tone: "var(--green)" },
      { label: "Equity Vol · VSTOXX", tag: "Risk-on / risk-off tripwire", val: "16.4", chg: null, state: "Calm", note: "Subdued — supportive backdrop.", tone: "var(--green)" },
      { label: "EUR/USD", tag: "Global liquidity valve", val: "1.082", chg: -0.2, state: "", note: "Soft EUR eases financial conditions.", tone: "var(--green)" },
      { label: "Curve · 2s10s", tag: "Late-cycle / recession watch", val: "-0.11", chg: null, state: "Flat", note: "Mildly inverted — bull-steepening watch.", tone: "var(--amber)" },
    ],
    cross: [
  ...
  CN: {
    exchange: "SSE · CST", regimeLabel: "Deflation Risk", regimeColor: "var(--red)", regimeDays: 132, regimeSince: "Feb 20",
    history: [
      { label: "Reopening", color: "var(--green)", w: 30 },
      { label: "Slowdown", color: "#C9A24B", w: 38 },
      { label: "Deflation risk", color: "var(--red)", w: 60 },
      { label: "Deflation risk", color: "var(--red)", w: 24 },
    ],
    ...
    playbook: [
      { side: "LONG", asset: "CGB duration", note: "deflation bid", color: "var(--green)" },
      { side: "FADE", asset: "CNY strength", note: "easing bias", color: "var(--amber)" },
      { side: "WATCH", asset: "Stimulus proxies", note: "policy optionality", color: "var(--amber)" },
      { side: "SHORT", asset: "Industrial metals", note: "demand deficit", color: "var(--red)" },
    ],
    curve: [["3M", 1.75], ["1Y", 1.85], ["2Y", 1.98], ["5Y", 2.02], ["7Y", 2.05], ["10Y", 2.08], ["30Y", 2.28]],
    tripwires: [
      { label: "Credit · Property HY", tag: "Leading tell for equity stress", val: "21.4%", chg: 0.6, unit: " pp", state: "", note: "Elevated — property stress lingers.", tone: "var(--red)" },
      { label: "Equity Vol · CSI Vol", tag: "Risk-on / risk-off tripwire", val: "19.8", chg: null, state: "Uneasy", note: "Policy-headline sensitive.", tone: "var(--amber)" },
      { label: "USD/CNH", tag: "Global liquidity valve", val: "7.28", chg: 0.15, state: "", note: "Weaker CNH signals easing pressure.", tone: "var(--amber)" },
      { label: "Curve · 2s10s", tag: "Late-cycle / recession watch", val: "+0.10", chg: null, state: "Flat", note: "Very flat — low growth expectations.", tone: "var(--amber)" },
    ],
    cross: [
  ...
  JP: {
    exchange: "TSE · JST", regimeLabel: "Reflation", regimeColor: "var(--green)", regimeDays: 210, regimeSince: "Dec 3",
    history: [
      { label: "Deflation", color: "var(--red)", w: 40 },
      { label: "Exit", color: "#C9A24B", w: 30 },
      { label: "Reflation", color: "var(--green)", w: 64 },
      { label: "Reflation", color: "var(--green)", w: 28 },
    ],
    ...
    playbook: [
      { side: "SHORT", asset: "JGB duration", note: "normalization", color: "var(--red)" },
      { side: "LONG", asset: "JPY vs USD", note: "carry unwind", color: "var(--green)" },
      { side: "LONG", asset: "JP banks", note: "steeper curve", color: "var(--green)" },
      { side: "FADE", asset: "Exporters", note: "stronger yen", color: "var(--amber)" },
    ],
    curve: [["3M", 0.1], ["1Y", 0.28], ["2Y", 0.44], ["5Y", 0.72], ["7Y", 0.88], ["10Y", 1.06], ["30Y", 2.1]],
    tripwires: [
      { label: "Credit · JP IG", tag: "Leading tell for equity stress", val: "62", chg: -1, unit: "", state: "bp", note: "Tight — corporate stress low.", tone: "var(--green)" },
      { label: "Equity Vol · N225 Vol", tag: "Risk-on / risk-off tripwire", val: "20.6", chg: null, state: "Elevated", note: "FX-driven volatility risk.", tone: "var(--amber)" },
      { label: "USD/JPY", tag: "Global liquidity valve", val: "156.2", chg: -0.4, state: "", note: "Intervention watch above 158.", tone: "var(--amber)" },
      { label: "Curve · 2s10s", tag: "Late-cycle / recession watch", val: "+0.62", chg: null, state: "Steep", note: "Bear-steepening as BoJ exits.", tone: "var(--green)" },
    ],
    cross: [
  ...
  GL: {
    exchange: "Global · UTC", regimeLabel: "Late Cycle", regimeColor: "var(--amber)", regimeDays: 63, regimeSince: "Apr 29",
    history: [
      { label: "Recovery", color: "var(--green)", w: 30 },
      { label: "Mid cycle", color: "#8FA05A", w: 34 },
      { label: "Late cycle", color: "var(--amber)", w: 56 },
      { label: "Late cycle", color: "var(--amber)", w: 28 },
    ],
    ...
    playbook: [
      { side: "UW", asset: "DM duration", note: "reflation pulse", color: "var(--red)" },
      { side: "OW", asset: "Real assets", note: "inflation hedge", color: "var(--green)" },
      { side: "OW", asset: "EM ex-China", note: "carry + easing", color: "var(--green)" },
      { side: "NEUTRAL", asset: "DM equities", note: "valuation-capped", color: "var(--amber)" },
    ],
    curve: [["3M", 4.1], ["1Y", 3.8], ["2Y", 3.55], ["5Y", 3.4], ["7Y", 3.44], ["10Y", 3.42], ["30Y", 3.7]],
    tripwires: [
      { label: "Credit · Global HY", tag: "Leading tell for equity stress", val: "3.60%", chg: 0.08, unit: " pp", state: "", note: "Contained — no systemic widening.", tone: "var(--green)" },
      { label: "Equity Vol · VIX", tag: "Risk-on / risk-off tripwire", val: "17.4", chg: null, state: "Contango", note: "Calm cross-asset vol regime.", tone: "var(--green)" },
      { label: "Dollar · DXY", tag: "Global liquidity valve", val: "103.9", chg: -0.1, state: "", note: "Sideways USD — liquidity neutral.", tone: "var(--green)" },
      { label: "Curve · 2s10s", tag: "Late-cycle / recession watch", val: "-0.13", chg: null, state: "Flat", note: "Aggregate near flat — dispersion high.", tone: "var(--amber)" },
    ],
    cross: [
