// Ported near-verbatim from OpenTerminal's server/src/providers/secedgar.ts.
/* eslint-disable @typescript-eslint/no-explicit-any -- parsing SEC EDGAR's JSON
   and XML-derived Form 4 documents; kept loosely typed same as upstream. */
