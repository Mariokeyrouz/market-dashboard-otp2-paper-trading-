// Ported near-verbatim from OpenTerminal's server/src/providers/news.ts.
/* eslint-disable @typescript-eslint/no-explicit-any -- parsing RSS-derived JSON
   whose shape depends on fast-xml-parser's attribute conventions; kept loosely
   typed same as upstream. */
