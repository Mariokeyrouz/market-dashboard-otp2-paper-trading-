// Ported near-verbatim from OpenTerminal's server/src/providers/binance.ts.
/* eslint-disable @typescript-eslint/no-explicit-any -- parsing Binance's public
   JSON response rows; kept loosely typed same as upstream. */
import type { CryptoRow } from "./coingecko";
import type { Quote, Candle } from "./yahoo";
