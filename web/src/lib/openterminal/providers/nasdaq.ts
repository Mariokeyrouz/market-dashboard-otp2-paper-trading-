// Ported near-verbatim from OpenTerminal's server/src/providers/nasdaq.ts.
/* eslint-disable @typescript-eslint/no-explicit-any -- parsing Nasdaq's unofficial,
   undocumented JSON responses; kept loosely typed same as upstream. */
