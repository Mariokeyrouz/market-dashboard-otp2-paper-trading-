// Ported near-verbatim from OpenTerminal's server/src/providers/tradingview.ts.
/* eslint-disable @typescript-eslint/no-explicit-any -- parsing TradingView's
   unofficial scanner JSON; kept loosely typed same as upstream. */
