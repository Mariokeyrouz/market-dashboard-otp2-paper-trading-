// Ported unchanged (aside from the store import) from OpenTerminal's
// web/components/Sidebar.tsx.
"use client";

import { useOpenTerminal, type WidgetType } from "@/store/openterminal";
...
export default function Sidebar() {
  ...
  const resetWorkspace = useOpenTerminal((s) => s.resetWorkspace);
