// Ported from OpenTerminal's web/components/widgets/NewsWidget.tsx.
...
export default function NewsWidget({ widget }: { widget: WidgetInstance }) {
  ...
  const { data = [], isLoading } = useQuery({
    ...
    queryFn: () => apiGet<NewsItem[]>(mode === "symbol" ? `/api/openterminal/news?symbol=${symbol}` : "/api/openterminal/news"),
