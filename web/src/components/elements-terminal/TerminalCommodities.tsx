...
export default function TerminalCommodities() {
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: compact ? 0 : 2 }}>
        {v.commods.map((c) => (
          <div
            key={c.name}
            style={{
              display: "grid", gridTemplateColumns: "1fr auto 62px 72px",
              gap: 12, alignItems: "center", lineHeight: compact ? 1.05 : undefined,
              padding: compact ? "3px 0" : "4px 0", borderBottom: "1px solid var(--hairline)",
            }}
          >
